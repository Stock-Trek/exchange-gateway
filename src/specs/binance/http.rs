...
fn to_request(request: BinanceHttpRequest, api_key: Option<&str>) -> EGResult<HttpRequest> {
    ...
    let (method, query) = match unsigned {
...
fn signed_query(query: &str, signature: Option<String>) -> String {
    match signature {
...
mod test {
    ...
    #[test]
    #[cfg(feature = "reqwest")]
    fn order_request_without_credentials_omits_the_api_key_header() {
        let request = BinanceHttpRequest {
    ...
    #[test]
    fn signed_request_gets_a_signature() {
